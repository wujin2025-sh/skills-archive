...
PYTHONUNBUFFERED=1 .venv/bin/python ~/.workbuddy/skills/参数中心/scripts/edit_schedule.py PG202204-0155
```

> 必须加 `PYTHONUNBUFFERED=1`，否则 Python 输出缓冲会导致日志不完整，难以判断脚本进度。
