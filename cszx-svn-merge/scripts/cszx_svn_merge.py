...
if os.name == 'nt':
    DEFAULT_LOCAL_DIR = r"D:\jygl\jygl_sys"
else:
    DEFAULT_LOCAL_DIR = r"/Volumes/Macintosh HD_Data/Project/jygl/jygl_sys"
DEFAULT_MERGE_SOURCE = "https://jyjs.svn.gtja.net/svn/jjywpt/Src/01Branches/02Trunk_jygl_prod/jygl_uat_2024"
...
def main():
    parser = argparse.ArgumentParser(description="CSZX SVN Task编号粒度代码合并工具")
